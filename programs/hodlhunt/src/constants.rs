pub mod ocean {
    ...
    pub const INITIAL_STORM_PROBABILITY_BPS: u16 = 350; // 35%
}
...
pub mod marks {
    pub const PLACEMENT_WINDOW_SECONDS: i64 = 24 * 60 * 60; // 24 hours
    pub const HIGH_RATE_THRESHOLD_SECONDS: i64 = 3 * 60 * 60; // 3 hour
    pub const EXCLUSIVITY_SECONDS: i64 = 30 * 60; // 30 minutes
}
